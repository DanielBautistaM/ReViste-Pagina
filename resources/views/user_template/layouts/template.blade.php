               ...
               <div class="containt_main">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="{{asset('home/images/flag-uk.png')}}" alt="flag" class="mr-2 " title="United Kingdom"> Ingles <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
               ...
               <div id="my_slider" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Comienza <br>Tu Tienda Favorita</h1>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-4 col-sm-4">
                              <div class="box_main">
                                 ...
                                 <p class="price_text">Precio Inicial  <span style="color: #262626;">$ 100</span></p>
