                    ...
                    <div class="card-body">
                      <form action="" method="POST">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="subcategory_name" name="category_name" placeholder="Pantalones" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="number" class="form-control" id="subcategory_name" name="category_name" placeholder="100.000" />
                          </div>
                        </div>
